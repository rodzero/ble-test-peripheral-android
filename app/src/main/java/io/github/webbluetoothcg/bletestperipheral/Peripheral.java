...
import static io.github.webbluetoothcg.bletestperipheral.Peripherals.ADVERTISE_MAC_ADDRESS_PREF;
...
public class Peripheral extends Activity implements ServiceFragmentDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            mCurrentServiceFragment = new TemperatureServiceFragment();
        ...
        String macAddressString = getSharedPreferences(ADVERTISE_MAC_ADDRESS_PREF, MODE_PRIVATE).getString(ADVERTISE_MAC_ADDRESS_PREF, Peripherals.DEFAULT_MACADDRESS);

        mAdvData = new AdvertiseData.Builder()
                .setIncludeTxPowerLevel(true)
                .addManufacturerData(1, macAddressString.getBytes())
